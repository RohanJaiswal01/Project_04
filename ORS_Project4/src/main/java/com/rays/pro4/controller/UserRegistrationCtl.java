...
public class UserRegistrationCtl extends BaseCtl{
    ...
    protected boolean validate(HttpServletRequest request) {
        ...
        if (DataValidator.isNull(request.getParameter("firstName"))) {
        	...
        	request.setAttribute("firstName","First name should contain only letters" );
			pass = false;
		}
        ...
        if (DataValidator.isNull(request.getParameter("lastName"))) {
        	...
        	request.setAttribute("lastName","Last name should contain only letters");
			pass = false;
        }
      //  System.out.println(login+"sssssssssssssssssssssssssss");
        ...
        if (DataValidator.isNull(request.getParameter("password"))) {
        	...
        	request.setAttribute("password", "Password contain 8 letters with 1st letter capital, alpha-numeric & special Character");
        	pass = false;
        }
