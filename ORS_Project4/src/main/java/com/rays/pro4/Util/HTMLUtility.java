...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal,
        ...
        StringBuffer sb = new StringBuffer(
                "<select style='width: 185px;  height: 22px;' class='form-control' name='" + name + "'>");
        ...
        if (select)
        {
        	sb.append("<option style='width: 185px;  height: 22px;' selected value=''>--------------Select--------------------`</option>");
        }
...
;
 ...
 public static String getList(String name, String selectedVal, List list) {
        ...
        StringBuffer sb = new StringBuffer("<select style='width: 185px;  height: 22px;' class='form-control' name='" + name + "'>");
